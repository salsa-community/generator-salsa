...
module.exports = class modelReader {
  ...
  static createProperty(context, name) {
    ...
    let base = {
      ...
      tooltip: context.row.tooltip,
      tooltipEn: context.row.tooltipEn,
      placeHolder: context.row.placeholder,
      placeHolderEn: context.row.placeholderEn,
      description: context.row.descripcion,
      descriptionEn: context.row.descripcionEn,
      title: context.row.etiqueta,
      titleEn: context.row.etiquetaEn,
      catalog: context.row.catalogo,
      type: objectType,
      uiType: uiType,
      isLeaf: isLeaf,
    };
